...
-- changeset auth:7
ALTER TABLE _user ADD COLUMN nickname VARCHAR(50) NOT NULL DEFAULT 'user';
...
-- changeset auth:9
ALTER TABLE _user ALTER COLUMN nickname DROP DEFAULT;
...
ALTER TABLE refresh_token ADD CONSTRAINT fk_refresh_token_user FOREIGN KEY (user_id) REFERENCES _user (id) ON DELETE CASCADE;
